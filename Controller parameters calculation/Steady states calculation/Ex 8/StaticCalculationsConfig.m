...
%        Parameter.VSC.v_rated         	= 0;      
        ...
        [v_rated,Omega_dot_Sq,exitflag] = fminbnd(fun,v_0_min,v_0_max,optimset('Display','none'));
    ...
    case {'NREL5MW_FBSWE'}        
        ...
        %% find v of the torque controller regions 
        
        % v 1 to 1.5:
        ThetaMin    = min(Parameter.Turbine.SS.theta);
        M_g         = Parameter.VSC.NonlinearStateFeedback(Parameter.VSC.Omega_g_1d5,ThetaMin,Parameter);
        v_0_min     = min(v_0);
        v_0_max     = max(v_0);
        fun = @(x)(OmegaDot(Parameter.VSC.Omega_g_1d5,ThetaMin,M_g,x,Parameter))^2; 
        Parameter.VSC.v_1to1d5 = fminbnd(fun,v_0_min,v_0_max);
        
         % v 1.5 to 2:
        ThetaMin    = min(Parameter.Turbine.SS.theta);
        M_g         = Parameter.VSC.NonlinearStateFeedback(Parameter.VSC.Omega_g_1d5,ThetaMin,Parmeter);
        v_0_min     = min(v_0);
        v_0_max     = max(v_0);
        fun = @(x)(OmegaDot(Parameter.VSC.Omega_g_1d5,ThetaMin,M_g,x,Parameter))^2; 
        Parameter.VSC.v_1to1d5 = fminbnd(fun,v_0_min,v_0_max);
