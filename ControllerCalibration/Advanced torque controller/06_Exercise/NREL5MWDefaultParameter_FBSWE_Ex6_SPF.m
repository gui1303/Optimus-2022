function [Parameter] = NREL5MWDefaultParameter_FBSWE_Ex6_SPF(Parameter)
...
%% Set-Point-Fading
Parameter.VSC.Delta_Omega_g             = 1*Parameter.CPC.Omega_g_rated;    % [rad/s]   % Please adjust !!! % over-/under-speed limit for setpoint-fading, first guess
Parameter.VSC.Delta_theta               = deg2rad(1);                       % [rad]     % Please adjust !!! % change of pitch angle at which under-speed limit should be reached, brute-force-optimized
Parameter.VSC.Delta_P                   = 1e6;                          	% [W]       % Please adjust !!! % change of power at which over-speed limit should be reached, first guess
