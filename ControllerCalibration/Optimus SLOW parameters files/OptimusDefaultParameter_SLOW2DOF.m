...
Parameter.Turbine.i               	= 1/58.5;             % [-]       gearbox ratio
Parameter.Turbine.R              	= 255/2;            % [m]       Rotor radius

% Generator
Parameter.Generator.eta_el      	= 0.955;            % [-]       Generator efficiency
Parameter.Generator.M_g_dot_max     = 0.3778e6/4;             % [Nm/s]    maximum torque rate, 1/4 of rated

% drive-train dynamics
J_G                               	= 40996;          % [kgm^2]	Generator Inertia About High-Speed Shaft
J_R                                	= 491425312;      % [kgm^2]	Rotor Inertia About High-Speed Shaft
...
f_0TwFADOF1                         = 0.224;            % [Hz]      first tower fore-aft eigenfrequency
Parameter.Turbine.x_T0           	= 2*(-0.0140);          % [m]       tower top deflection without wind
Parameter.Turbine.k_Te            	= 2205270.328;         % [kg/s^2]  tower equivalent bending stiffness 
